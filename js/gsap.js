...
const formations = presentation.querySelectorAll(".formation__element");
...
const toLearnTitle = presentation.querySelector(".tolearn__title")
...
gsap.from(toLearnTitle, {
    scrollTrigger: {
        trigger:toLearnTitle,
        start: "-20px 80%",
